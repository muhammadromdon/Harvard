...
<head>
    ...
    <title>Acces Forbidden</title>

    <!-- Custom fonts for this template-->
    <link href="<?php echo base_url() ?>plugins/sbadmin2/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">

    <!-- Custom styles for this template-->
    <link href="<?php echo base_url() ?>plugins/sbadmin2/css/sb-admin-2.min.css" rel="stylesheet">
            ...
            <div id="content">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <div class="text-center">
                        ...
                        <a href="<?php echo base_url() ?>Users">&larr; Back to Dashboard</a>
                    </div>
